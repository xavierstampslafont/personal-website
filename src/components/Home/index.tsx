    ...
    return (
      <React.Fragment>
        ...
        <p>
          ...
          worked on web-based products, SaaS software, and games. As a
          developer, my mission is to create long-term value through code.
        </p>
        <p>
          Currently I work at{" "}
        ...
        <p>
          ...
          enjoy spending time with my family, playing video games, and becoming
          a better developer.
        </p>
      </React.Fragment>
    );
